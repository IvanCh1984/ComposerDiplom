...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="downloadAvatar" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <input name="id" value="<?= $_GET['id'];?>" type="hidden">
                                <div class="form-group">
                                    <?php $image = 'upload/' . $user['avatar'];?>
                                    <img src="<?=($user["avatar"]) ? "$image" : "../img/demo/avatars/avatar-admin-lg.png";?>" alt="" class="img-responsive" width="200">
                                </div>
