                                ...
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <form id="js-login" novalidate="" action="registerUser" method="post">
                                        <div class="form-group">
                                             ...
                                             <input type="text" id="emailverify" name="name" class="form-control" placeholder="Ваше имя" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" id="userpassword" name="password" class="form-control" placeholder="Пароль" required>
                                            <div class="invalid-feedback">Заполните поле.</div>
                                        </div>
