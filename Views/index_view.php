                            ...
                            <div class="card p-4 rounded-plus bg-faded">
                                ...
                                <form id="js-login" novalidate="" action="registerUser" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="emailverify" name="name_user" class="form-control"
                                               placeholder="Ваше имя" required>

                                        <label class="form-label" for="emailverify">Email</label>
                                        <input type="email" id="emailverify" name="email_user" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" id="userpassword" name="pass_user" class="form-control"
